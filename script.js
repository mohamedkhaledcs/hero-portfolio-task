...
menuItems.forEach(function (item, index) {
    ...
    link.href = index === 0 ? "#main-content" : "#main-content";
    link.setAttribute("aria-label", item);
...
hireNav.onmouseenter = function () {
    ...
    hireNav.style.boxShadow = "0 12px 35px rgba(255,113,0,0.35)";
...
description.textContent = "I build modern, responsive and user-friendly web applications with clean code and creative design.";
...
socialData.forEach(function (item) {
    ...
    link.onmouseenter =
        function () {
            ...
            link.style.boxShadow = "0 10px 25px rgba(255,113,0,0.25)";
...
hireBtn.onmouseenter =
    function () {
        hireBtn.style.transform = "translateY(-4px)";
        hireBtn.style.boxShadow = "0 15px 35px rgba(255,113,0,0.35)";

    };


hireBtn.onmouseleave =
    function () {
...
cvBtn.onmouseenter =
    function () {
        ...
        cvBtn.style.boxShadow = "0 10px 30px rgba(255,113,0,0.18)";
...
stats.style.border = "1px solid rgba(255,255,255,0.05)";
    ...
    function (item, index) {
        ...
        stat.onmouseenter =
            function () {
                ...
                number.style.textShadow = "0 0 15px rgba(255,113,0,0.6)";
...
imageArea.setAttribute(
    "aria-label",
    "Mohamed Khaled profile image and skills"
);
...
circle.style.border = "1px solid rgba(255,113,0,0.5)";
...
person.alt =
    "Mohamed Khaled, Frontend Developer";
...
person.setAttribute(
    "aria-label",
    "Show Mohamed Khaled's technical skills"
);
...
person.style.animation = "floatImage 4s ease-in-out infinite";
person.style.transition = "0.4s";
person.style.filter = "drop-shadow(0 20px 40px rgba(0,0,0,0.5))";

imageArea.appendChild(person);


imageArea.onmouseenter =
    function () {
        person.style.transform = "translateY(-10px) scale(1.025)";
        person.style.filter = "drop-shadow(0 25px 50px rgba(255,113,0,0.25))";
        circle.style.transform = "scale(1.04)";
        circle.style.borderColor = "rgba(255,113,0,0.8)";

    };


imageArea.onmouseleave =
    function () {
        person.style.transform = "translateY(0) scale(1)";
        person.style.filter = "drop-shadow(0 20px 40px rgba(0,0,0,0.5))";
        circle.style.transform = "scale(1)";
        circle.style.borderColor = "rgba(255,113,0,0.5)";
